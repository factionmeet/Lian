...
// 侧边栏
const items = [
  { icon: 'el-icon-ali-home', index: '/dashboard5', title: '管理员首页' },
  { icon: 'el-icon-ali-home', index: '/dataScreen', title: '数据大屏展示' },
  {
    icon: 'el-icon-ali-cascades',
    index: '2',
    title: '用户管理',
    subs: [
      { index: '/planterUser', title: '种植商' },
      { index: '/processUser', title: '加工商商' },
      { index: '/logisticsUser', title: '储运商' },
      { index: '/saleUser', title: '经销商' }
    ],
  },
  {
    icon: 'el-icon-ali-cascades',
  ...
  },
  {
    ...
    title: '个人管理',
    subs: [
      { index: '/passwordChange5', title: '密码修改' }
    ],
  },
