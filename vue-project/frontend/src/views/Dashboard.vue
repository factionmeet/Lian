...
<!--            </el-card>-->
    ...
    <button @click="TodataScreen">数据展示</button> -->
...
import { UserFilled, Message, Goods, Edit, Delete } from '@element-plus/icons';
import dataScreen from "@views/dataScreen/index.vue"; // 图标
