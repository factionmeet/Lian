...
<!--编辑弹窗-->
    ...
    >
            <el-form status-icon label-width="100px" ref="formRef" :model="allData.editData" >
              <el-form-item label="仓储地点" prop="location">
                <el-input v-model="allData.editData.location" placeholder="请输入仓储地点"  />
              </el-form-item>
              <el-form-item label="运输人" prop="transportPerson">
                <el-input v-model="allData.editData.transportPerson" placeholder="请输入运输人"   />
              </el-form-item>
              <el-form-item label="出发地" prop="leaveAddress">
                <el-input v-model="allData.editData.leaveAddress"  placeholder="请输入出发地"  />
              </el-form-item>
              <el-form-item label="目的地" prop="arriveAddress">
                <el-input v-model="allData.editData.arriveAddress" placeholder="请输入目的地"   />
              </el-form-item>
              <el-form-item label="出发时间" prop="inTime">
              <el-date-picker  v-model="allData.editData.inTime" type="date" placeholder="Pick a day">
              </el-date-picker>
              </el-form-item>
              <el-form-item label="到达时间" prop="outTime">
                <el-date-picker  v-model="allData.editData.outTime" type="date" placeholder="Pick a day">
                </el-date-picker>
              </el-form-item>
            </el-form>
