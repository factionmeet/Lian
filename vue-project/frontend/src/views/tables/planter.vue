...
<!--添加弹窗-->
    ...
    >
      <el-form status-icon label-width="100px" ref="formRef" :model="allData.addData" >
        <el-form-item label="农产品名称" prop="planterName">
          <el-input v-model="allData.addData.planterName" placeholder="请输入农产品名称"  />
        </el-form-item>
...
<!--编辑弹窗-->
    ...
    >
      ...
      <el-form-item label="农产品名称" prop="temperature">
        <el-input v-model="allData.editData.planterName" placeholder="请输入农产品名称"  />
      </el-form-item>
      <el-form-item label="温度(℃)" prop="temperature">
        <el-input v-model="allData.editData.temperature" placeholder="请输入温度"  />
      </el-form-item>
      <el-form-item label="环境湿度" prop="envHumidity">
        <el-input v-model="allData.editData.envHumidity" placeholder="请输入环境湿度" maxlength="20"  />
      </el-form-item>
      <el-form-item label="ph值" prop="ph">
...
<!--数据展示-->
    <el-table
      ...
      <el-table-column prop="temperature" label="温度" width="150" />
      <el-table-column prop="envHumidity" label="环境湿度" width="150" />
      <el-table-column prop="ph" label="ph值" width="150" />
