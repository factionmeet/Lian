...
<!--编辑弹窗-->
    ...
    >
            <el-form status-icon label-width="100px" ref="formRef" :model="allData.editData" >
              <el-form-item label="加工厂名称" prop="factoryName">
                <el-input v-model="allData.editData.factoryName" placeholder="请输入加工厂名称"  />
              </el-form-item>
              <el-form-item label="质检人员" prop="qualityInspector">
                <el-input v-model="allData.editData.qualityInspector" placeholder="请输入质检人员"   />
              </el-form-item>
              <el-form-item label="加工人员" prop="processPerson">
                <el-input v-model="allData.editData.processPerson" placeholder="请输入加工人员"   />
              </el-form-item>
<!--              <el-form-item label="加工时间" prop="date">-->
<!--                <el-input v-model="allData.editData.date"  placeholder="请输入加工时间"  />-->
<!--              </el-form-item>-->
              <el-form-item label="加工时间" prop="date">
                <el-date-picker  v-model="allData.editData.date" type="date" placeholder="Pick a day">
                </el-date-picker>
              </el-form-item>
            </el-form>
